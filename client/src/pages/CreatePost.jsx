...
const CreatePost = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (form.prompt && form.photo) {
      setLoading(true);
      try {
        const response = await fetch('https://ai-image-xkc8.onrender.com/api/v1/post', {
          method: 'POST',
          headers: {
  ...
  const generateImage = async () => {
    if (form.prompt) {
      try {
        ...
        const responce = await fetch('https://ai-image-xkc8.onrender.com/api/v1/dalle', {
          method: 'POST',
          headers: {
            'Content-Type': 'application/json'
          },
  ...
  return (
    <section className='max-w-7xl mx-auto'>
      <div>
        ...
        Create imagindative and visually stunning images generated through AI share them with the community 
        </p>
      </div>
      <form
      ...
      >
        ...
        <div className='mt-10'>
          <p className='mt-2 text-[#666e75] text-[14px]'>
            ...
            shre it with others in the community
          </p>
          <button
          type='submit'
